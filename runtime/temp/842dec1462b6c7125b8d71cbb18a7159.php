<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"/var/www/html/ezsy/public/../application/admin/view/user/add.html";i:1497921203;s:71:"/var/www/html/ezsy/public/../application/admin/view/layout/default.html";i:1497887290;s:68:"/var/www/html/ezsy/public/../application/admin/view/common/meta.html";i:1497887290;s:70:"/var/www/html/ezsy/public/../application/admin/view/common/script.html";i:1497887290;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-salt" data-rule="required" class="form-control" name="row[salt]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-gender" class="form-control" name="row[gender]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
        <label for="c-birthday" class="control-label col-xs-12 col-sm-2"><?php echo __('Birthday'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-birthday" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" data-use-current="true" name="row[birthday]" type="text" value="<?php echo date('Y-m-d'); ?>">
        </div>
    </div>
    <div class="form-group">
